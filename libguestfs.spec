...
createrepo repo
%define extra --with-mirror=file://$(pwd)/repo --with-repo=fedora-13 --with-updates=none
%endif
...
%changelog
* Thu Nov 18 2010 Richard Jones <rjones@redhat.com> - 1:1.6.2-1.fc13.2
...
* Mon Jul 12 2010 Richard W.M. Jones <rjones@redhat.com> - 1:1.4.1-1
...
* Mon May 24 2010 Richard W.M. Jones <rjones@redhat.com> - 1:1.2.8-1
- New upstream branch version 1.2.8.
- Fixes RHBZ#501894.

* Thu May 20 2010 Richard W.M. Jones <rjones@redhat.com> - 1:1.2.7-2.1
- Bump and rebuild.

* Mon May 17 2010 Richard W.M. Jones <rjones@redhat.com> - 1:1.2.7-2
- New upstream stable branch version 1.2.7.
- Add BUGS file to documentation section.

* Fri May 14 2010 Richard W.M. Jones <rjones@redhat.com> - 1:1.2.6-1
- New upstream stable branch version 1.2.6.

* Fri Apr 30 2010 Richard W.M. Jones <rjones@redhat.com> - 1:1.2.5-2
...
* Fri Apr 23 2010 Richard W.M. Jones <rjones@redhat.com> - 1:1.2.4-1
