...
%changelog
* Thu Dec 22 2011 Richard W.M. Jones <rjones@redhat.com> - 1:1.8.16-1
- New upstream version 1.8.16.
- Fixes Security: Mitigate possible privilege escalation via SG_IO ioctl
  (CVE-2011-4127, RHBZ#757071).

* Thu Nov 10 2011 Richard W.M. Jones <rjones@redhat.com> - 1:1.8.15-1
- New upstream stable branch version 1.8.15.

* Mon Oct 31 2011 Richard W.M. Jones <rjones@redhat.com> - 1:1.8.14-1
- New upstream stable branch version 1.8.14.

* Fri Sep 16 2011 Richard W.M. Jones <rjones@redhat.com> - 1:1.8.13-1
- New upstream stable branch version 1.8.13.

* Wed Aug 17 2011 Richard W.M. Jones <rjones@redhat.com> - 1:1.8.12-1
- New upstream stable branch version 1.8.12.

* Mon Aug  8 2011 Richard W.M. Jones <rjones@redhat.com> - 1:1.8.11-1
- New upstream stable branch version 1.8.11.

* Wed Jul 27 2011 Richard W.M. Jones <rjones@redhat.com> - 1:1.8.10-1
- New upstream stable branch version 1.8.10.

* Sat Jul 16 2011 Richard W.M. Jones <rjones@redhat.com> - 1:1.8.9-1
- New upstream stable branch version 1.8.9.

* Mon Jun 13 2011 Richard W.M. Jones <rjones@redhat.com> - 1:1.8.8-1
- New upstream stable branch version 1.8.8.
