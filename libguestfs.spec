...
%changelog
* Fri Mar 30 2012 Richard W.M. Jones <rjones@redhat.com> - 1:1.2.14-8
- Bump and rebuild.
...
- New upstream stable branch version 1.2.8.
- Fixes RHBZ#501894.
...
* Wed Apr 14 2010 Richard W.M. Jones <rjones@redhat.com> - 1:1.2.2-1.el5.6
- Backport the new API aug_clear from upstream development branch.
