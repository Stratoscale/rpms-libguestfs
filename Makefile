...
build:
	sudo docker run --rm -i --name=rpm-builder -v `pwd`:/home/makerpm/$(current_dir) rackattack-nas.dc1:5000/stratoscale/fedora-binary-rpm-builder-base:latest /bin/bash -c "make -f Makefile.libguestfs -C /home/makerpm/$(current_dir) && make -f Makefile.libguestfs -C /home/makerpm/$(current_dir) submit"
